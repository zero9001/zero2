...
local UserName = (data.username_ or "zeroO088")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ˹Z҉E҉ℛO҉˼")  
...
send(msg.chat_id_, msg.id_,' ۞ تم تحديث السورس \n ۞ لديك اخر اصدار لسورس زيرو\n ۞ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ۞ اصدار سورس  زيرو\n ۞ الاصدار »{ v 1.5}')
end
...
if text == '≪━━━━━˹Z҉E҉ℛO҉˼━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/zeroO088)
]] 
...
usertext = '\n ۞ العضو » ['..result.title_..'](t.me/'..(username or 'zeroO088')..')'
status  = '\n ۞ تم ترقيته مطور'
...
usertext = '\n ۞ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'zeroO088')..')'
status  = '\n ۞ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ۞ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zeroO088')..') \n ۞ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'زيرو' or text == 'zero' or text == 'ZERO' then
local Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ۞ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zeroO088')..') \n ۞ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ۞ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'zeroO088')..') \n ۞ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1466455779) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ۞ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'zeroO088')..')'
status  = '\n ۞ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ۞ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ۞ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'zeroO088')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ۞ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'zeroO088')..')'..'\n ۞ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."zeroO088:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'۞ تم تفعيل الانستا')
database:set(bot_id.."zeroO088:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."zeroO088:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."zeroO088:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"۞تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."zeroO088:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."zeroO088:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/zeroO088)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/zeroO088)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/zeroO088)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'zeroO088')..')'
local iduser = result.sender_user_id_
...
local Text =[[
         اتبع الازرار تحت ب اوامر سورس زيرو —͟͞ 
